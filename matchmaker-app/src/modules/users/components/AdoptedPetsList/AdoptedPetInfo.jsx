...
export default withAuthInfo(function AdoptedPetInfo({
  pet,
  setVisibleSignIn,
  isLoggedIn,
  user,
  ...
  const { imagesURL, name, _id, adopted_date } = pet;
  ...
  return (
    <div
      ...
      <div className="p-6 cursor-pointer" onClick={onClickNavigateToDetails}>
        <p className="text-lg font-semibold text-[#127475]">
          Adopted date: {new Date(adopted_date).toLocaleDateString()}
        </p>
