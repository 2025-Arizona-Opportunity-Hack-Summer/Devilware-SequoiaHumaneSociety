  ...
  return (
    <div className="homepage min-h-screen bg-white" style={{ color: "#252525" }}>
          ...
          <div className="space-y-6 md:space-y-8 text-center lg:text-left">
            ...
            <div className="space-y-4">
              <p
                ...
                This is the{" "}
                <span className="font-bold text-[#C1272D] bg-[#C1272D]/10 px-2 py-1 rounded-lg">Sequoia</span> Humane
                Society!
              </p>

              <p className="text-base sm:text-lg text-[#888888] leading-relaxed max-w-xl mx-auto lg:mx-0">
                Where compassion meets action. We're dedicated to creating a world where every animal is treated with
              ...
              <div className="text-center space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-[#888888]">
                    Join our mission to provide shelter, care, and love to animals in need.
                  </p>
                </div>
      ...
      <div className="bg-gray-50 py-16 sm:py-20 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 lg:mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-[#252525] mb-4">ABOUT OUR SHELTER</h2>
            <p className="text-base sm:text-lg text-[#888888] max-w-3xl mx-auto">
              We're more than just a shelter - we're a community dedicated to animal welfare and responsible pet
              ownership.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="group bg-white p-8 rounded-2xl shadow-md hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
              ...
              <p className="text-base text-[#888888] leading-relaxed">
                Every animal receives individualized attention, medical care, and love from our dedicated team of
                professionals.
              </p>
            </div>
            <div className="group bg-white p-8 rounded-2xl shadow-md hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
              ...
              <p className="text-base text-[#888888] leading-relaxed">
                We work closely with local families and organizations to create lasting bonds between pets and their
                forever homes.
              </p>
            </div>
            <div className="group bg-white p-8 rounded-2xl shadow-md hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
              ...
              <p className="text-base text-[#888888] leading-relaxed">
                With over a decade of experience, we've successfully placed thousands of animals in loving, permanent
                homes.
              </p>
            </div>
          </div>
      ...
      <div className="bg-white py-16 sm:py-20 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2
              className="text-[#7C0F0F] font-bold uppercase text-3xl sm:text-4xl mb-4 tracking-wide"
              style={{ fontFamily: "Koulen, sans-serif" }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <p className="text-lg text-[#888888] leading-relaxed">
                The Sequoia Humane Society is a <strong className="text-[#7C0F0F]">no-kill shelter</strong> whose
                mission is to be a community leader in reducing pet overpopulation by providing a high-standard of care
                through adoption, spay/neuter and education programs.
              </p>
              <p className="text-lg text-[#888888] leading-relaxed">
                Every member of the Sequoia Humane Society—whether staff, volunteers, or foster parents—is devoted to
                caring for each of our shelter animals with the respect, love, and compassion they deserve every day.
              </p>
            </div>
      ...
      <div className="bg-gradient-to-r from-[#7C0F0F] to-[#C1272D] py-16 sm:py-20 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 lg:mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">STORIES OF HOPE</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 text-white">
              ...
              <p className="text-base mb-6 leading-relaxed text-white/90">
                "The team at Sequoia helped us find the perfect companion for our family. The adoption process was
                smooth, and they truly care about matching pets with the right homes."
              </p>
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 text-white">
              ...
              <p className="text-base mb-6 leading-relaxed text-white/90">
                "Volunteering at Sequoia has been incredibly rewarding. The staff is passionate, and seeing animals find
                their forever homes makes every moment worthwhile."
              </p>
              <div className="flex items-center">
                <div className="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center mr-4">
            ...
            <div className="bg-white/5 p-8 rounded-2xl">
              ...
              <form className="space-y-4">
                <input
                  ...
                  className="w-full bg-white/10 text-white placeholder-white/50 px-5 py-3 rounded-full border-2 border-transparent focus:outline-none focus:border-[#C1272D] transition-colors"
                />
                <input
                  type="email"
