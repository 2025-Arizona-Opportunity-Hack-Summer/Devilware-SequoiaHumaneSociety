function ProgressBar({ currIdx }) {
  ...
  switch (currIdx) {
    case 0:
      widthBar = "relative h-1 bg-[#7C0F0F] flex mb-20 w-[10%]";
      break;
    case 1:
      widthBar = "relative h-1 bg-[#7C0F0F] flex mb-20 w-[30%]";
      break;
    case 2:
      widthBar = "relative h-1 bg-[#7C0F0F] flex mb-20 w-[50%]";
      break;
    case 3:
      widthBar = "relative h-1 bg-[#7C0F0F] flex mb-20 w-[70%]";
      break;
    case 4:
      widthBar = "relative h-1 bg-[#7C0F0F] flex mb-20 w-[100%]";
      break;
  }
  ...
  return (
    <div className="relative h-1 bg-[#EFEFEF] flex mb-20 xl:w-[1000px]">
      ...
      <div className="absolute translate-[-50%] top-[500%] left-[10%] flex flex-col items-center max-w-[100px]">
        <div className={`w-12 h-12 ${currIdx < 0 ? "bg-[#EFEFEF]" : "bg-[#7C0F0F]"} rounded-full`}></div>
        <div>
      ...
      <div className="absolute translate-[-50%] top-[500%] left-[30%] flex flex-col items-center max-w-[100px]">
        <div className={`w-12 h-12 ${currIdx < 1 ? "bg-[#EFEFEF]" : "bg-[#7C0F0F]"} rounded-full`}></div>
        <div>
      ...
      <div className="absolute translate-[-50%] top-[500%] left-[50%] flex flex-col items-center max-w-[100px]">
        <div className={`w-12 h-12 ${currIdx < 2 ? "bg-[#EFEFEF]" : "bg-[#7C0F0F]"} rounded-full`}></div>
        <div>
      ...
      <div className="absolute translate-[-50%] top-[500%] left-[70%] flex flex-col items-center max-w-[100px]">
        <div className={`w-12 h-12 ${currIdx < 3 ? "bg-[#EFEFEF]" : "bg-[#7C0F0F]"} rounded-full`}></div>
        <div>
      ...
      <div className="absolute translate-[-50%] top-[500%] left-[90%] flex flex-col items-center max-w-[100px]">
        <div className={`w-12 h-12 ${currIdx < 4 ? "bg-[#EFEFEF]" : "bg-[#7C0F0F]"} rounded-full`}></div>
        <div>
